...
VAO_API int vao_set_geometry(void* handle, int32_t x, int32_t y, int32_t width,
                             int32_t height);
...
VAO_API int vao_submit_audio(void* handle, uint64_t generation, float angle,
                             float intensity, int64_t timestamp_ns);
...
VAO_API int set_geometry(void* handle, int32_t x, int32_t y, int32_t width,
                         int32_t height);
...
VAO_API int submit_audio(void* handle, uint64_t generation, float angle,
                         float intensity, int64_t timestamp_ns);
